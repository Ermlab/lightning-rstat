...
#' #' @section Methods:
#' \describe{
#'   For full documentation of each method go to https://github.com/Ermlab/lightining-rstat/
...
#'   \item{\code{line(series, index = NA, color = NA, label = NA, size = NA, xaxis = NA, yaxis = NA, logScaleX = "false", logScaleY = "false")}}{This method creates a line visualisation for vector/matrix with each row representing a line, given in in \code{series}.}
...
#'   \item{\code{matrix(matrix, colormap)}}{This method creates a visualization of matrix given in \code{matrix} parameter, with its contents used as weights for the colormap given in \code{colormap}.}
